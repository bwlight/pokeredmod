...
if DEF(_YELLOW)
	...
	db 9,ODDISH,WEEDLE,CATERPIE,0 ; Viridian Forest
	db 10,WEEDLE,CATERPIE,WEEDLE,0 ; Viridian Forest
	db 11,BUTTERFREE,WEEDLE,0 ; Viridian Forest
endc
...
if DEF(_YELLOW)
	...
	db 11,EEVEE,DIGLETT,SANDSHREW,0 ; Pewter City Gym
endc
...
SuperNerdData: ; 39f26 (e:5f26)
	...
	db 34,PONYTA,MAGIKARP,VULPIX,GROWLITHE,0
	db 41,RAPIDASH,0
...
BurglarData: ; 39fe4 (e:5fe4)
	...
	db 33,GROWLITHE,0
	db 28,VULPIX,MAGIKARP,PONYTA,0
	db 36,GROWLITHE,VULPIX,NINETALES,0
	db 41,PONYTA,0
	db 37,VULPIX,GROWLITHE,0
	db 34,MAGIKARP,CHARMELEON,0
	db 38,NINETALES,0
...
if DEF(_YELLOW)
	...
	db $FF,9,PIDGEY,8,ABRA,0
	db $FF,9,PIDGEY,8,MAGIKARP,0
	db $FF,18,PIDGEOTTO,15,MACHOP,15,RATTATA,17,GASTLY,0
	db $FF,18,PIDGEOTTO,15,MACHOP,15,RATTATA,17,ABRA,0
	db $FF,18,PIDGEOTTO,15,MACHOP,15,RATTATA,17,MAGIKARP,0
endc
...
if DEF(_YELLOW)
	...
	db $FF,13,GEODUDE,11,PORYGON,14,ONIX,0
endc
...
if DEF(_YELLOW)
	...
	db $FF,19,PIDGEOTTO,16,RATICATE,18,MACHOKE,20,HAUNTER,0
	db $FF,19,PIDGEOTTO,16,RATICATE,18,MACHOKE,20,KADABRA,0
	db $FF,19,PIDGEOTTO,16,RATICATE,18,MACHOKE,20,GYARADOS,0
	db $FF,25,PIDGEOTTO,23,GROWLITHE,22,EXEGGCUTE,20,MACHOKE,25,HAUNTER,0
	db $FF,25,PIDGEOTTO,23,GYARADOS,22,GROWLITHE,20,MACHOKE,25,KADABRA,0
	db $FF,25,PIDGEOTTO,23,EXEGGCUTE,22,GYARADOS,20,MACHOKE,25,GYARADOS,0
	db $FF,37,PIDGEOT,38,GROWLITHE,35,EXEGGCUTE,35,MACHAMP,40,GENGAR,0
	db $FF,37,PIDGEOT,38,GYARADOS,35,GROWLITHE,35,MACHAMP,40,ALAKAZAM,0
	db $FF,37,PIDGEOT,38,EXEGGCUTE,35,GYARADOS,35,MACHAMP,40,GYARADOS,0
	db $FF,47,PIDGEOT,45,RHYHORN,45,GROWLITHE,47,EXEGGCUTE,50,MACHAMP,53,GENGAR,0
	db $FF,47,PIDGEOT,45,RHYHORN,45,GYARADOS,47,GROWLITHE,50,MACHAMP,53,ALAKAZAM,0
	db $FF,47,PIDGEOT,45,RHYHORN,45,EXEGGCUTE,47,GYARADOS,50,MACHAMP,53,GYARADOS,0
endc
Green3Data: ; 3a491 (e:6491)
if DEF(_YELLOW)
	db $FF,61,SANDSLASH,59,MACHAMP,61,EXEGGUTOR,61,CLOYSTER,63,NINETALES,65,JOLTEON,0
	db $FF,61,SANDSLASH,59,MACHAMP,61,EXEGGUTOR,61,MAGNETON,63,CLOYSTER,65,FLAREON,0
	db $FF,61,SANDSLASH,59,MACHAMP,61,EXEGGUTOR,61,NINETALES,63,MAGNETON,65,VAPOREON,0
else
	db $FF,61,PIDGEOT,59,MACHAMP,61,RHYDON,61,ARCANINE,63,EXEGGUTOR,65,GENGAR,0
	db $FF,61,PIDGEOT,59,MACHAMP,61,RHYDON,61,GYARADOS,63,ARCANINE,65,ALAKAZAM,0
	db $FF,61,PIDGEOT,59,MACHAMP,61,RHYDON,61,EXEGGUTOR,63,GYARADOS,65,GYARADOS,0
endc
